...
Invoke-WebRequest -UseBasicParsing -Uri https://github.com/dchristian3188/WorkingWithDSC/raw/master/Certs/dscCert.pfx -OutFile C:\SSL\dscCert.pfx -Verbose
Invoke-WebRequest -UseBasicParsing -Uri https://github.com/dchristian3188/WorkingWithDSC/raw/master/Certs/dsc.cer -OutFile C:\SSL\dsc.cer -Verbose
Invoke-WebRequest -UseBasicParsing -Uri https://github.com/dchristian3188/WorkingWithDSC/raw/master/Certs/pullServer.pfx -OutFile C:\SSL\PullServer.pfx -Verbose
